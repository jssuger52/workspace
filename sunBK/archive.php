...
<?php 
		...
		// Content
		the_content(htmlspecialchars_decode($options[$current_archive_flag.'_readmore_text'])); 
?>
</div>
...
<footer><div class="meta-div portfolio"><?php showPostMetaForArchive(); ?></div></footer>
</article>
<?php
		endwhile;
?>
