...
if ($options['top_post_show_type'] == 'normal') : 
	$excerpt_length = $options['top_normal_excerpt_length'];
	?>
...
<?php 
	...
	// Content
	the_content(htmlspecialchars_decode($options['top_readmore_text'])); 
?>
</div>
...
elseif ($options['top_post_show_type'] === 'portfolio') : 
// ***********************************
// Portfolio View
// ***********************************
?>
...
elseif ($options['top_post_show_type'] === 'magazine') : 
// ***********************************
// Magazine View
// ***********************************
?>
...
<?php 
	...
	$excerpt_length = $options['top_magazine_excerpt_length'];
