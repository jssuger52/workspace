...
_EOD_;
	...
	// Video URL
	echo '<div class="dp_cf_item_box">
		<p style="font-weight:bold;">'.__('YouTube video ID:','DigiPress').'</p>
		 <p>'.__('Enter the YoTube video ID to play video in archive page.', 'DigiPress').'</p>
		 <input type="text" name="item_video_id" id="item_video_id" size="15" value="'.$item_video_id[0].'" /></div>';
...
_EOD_;
	...
	// Hide header
	// echo '<div class="dp_cf_item_box">
	// 	 <input name="dp_hide_header_menu"id="dp_hide_header_menu"type="checkbox" value=1';
	...
	// Hide footer
	// echo '<div class="dp_cf_item_box">
	// 	 <input name="dp_hide_footer" id="dp_hide_footer" type="checkbox" value=1';
